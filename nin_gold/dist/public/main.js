...
var AppComponent = /** @class */ (function () {
    function AppComponent(_dataService) {
        ...
        this.gold = 0;
        _dataService.goldChange.subscribe(function (x) { return _this.gold = x; });
    }
...
var FirstComponent = /** @class */ (function () {
    function FirstComponent(_httpService) {
        this._httpService = _httpService;
    }
    FirstComponent.prototype.Explore = function (type) {
        if (type == "house") {
...
var HttpService = /** @class */ (function () {
    function HttpService() {
        this.goldChange = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this.gold = 0;
        this.quotes = [];
    }
    HttpService.prototype.addgold = function (max, min, place) {
        var x = Math.floor(Math.random() * (max - min) + min);
        var line = "You've earned " + x;
        if (place == "casino") {
...
var SecondComponent = /** @class */ (function () {
    function SecondComponent(_httpService) {
        this._httpService = _httpService;
        this.quotes = this._httpService.quotes;
    }
